...
using ShopNServer.AdminPanel.Web.Menus;
...
public class AdminPanelWebModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
    {
        if (hostingEnvironment.IsDevelopment())
        {
            ...
            {
                options.FileSets.ReplaceEmbeddedByPhysical<AdminPanelDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}ShopNServer.AdminPanel.Domain.Shared"));
                options.FileSets.ReplaceEmbeddedByPhysical<AdminPanelApplicationContractsModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}ShopNServer.AdminPanel.Application.Contracts"));
